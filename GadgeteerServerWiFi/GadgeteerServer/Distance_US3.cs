...
namespace GadgeteerServer
{
    ...
    public class Distance_US3 : GTM.Module
    {
        ...
        public Distance_US3(int socketNumber)
        {
            ...
            Echo = GTI.DigitalInputFactory.Create(socket, GT.Socket.Pin.Three, GTI.GlitchFilterMode.Off, GTI.ResistorMode.Disabled, this);
            Trigger = GTI.DigitalOutputFactory.Create(socket, GT.Socket.Pin.Four, false, this);
        }
